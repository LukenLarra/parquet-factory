...
| 11  | **Run BDD Framework**                                   | Invokes `LukenLarra/RedHat-BDD-Framework@update-framework-config-for-external-use`. The action reads `framework.yml` from the repository root, runs behave, and publishes JUnit results as check annotations.                                                                                                                                                                            |
